...
export const projectType = defineType({
  ...
  fields: [
    ...
    defineField({name: 'client', title: 'Beställare', type: 'string', group: 'basics', description: 'Valfritt. Publicera först när namn och sekretess är godkända.'}),
    defineField({name: 'team', title: 'Arkitekt / team', type: 'array', group: 'basics', of: [{type: 'string'}], description: 'Valfritt. Ange endast medverkande som får namnges offentligt.'}),
