...
type Analytics = {configured: boolean; traffic?: {visitors?: number; uniqueVisitors?: number; pageviews?: number; returningVisitors?: number; topPages?: Array<{label: string; value: number}>; previous?: {visitors?: number; uniqueVisitors?: number; pageviews?: number; returningVisitors?: number}}; search?: {clicks?: number; impressions?: number; ctr?: number; position?: number; topPages?: Array<{label: string; value: number}>; queries?: Array<{label: string; value: number}>; previous?: {clicks?: number; impressions?: number}}; observations?: string[]; message?: string}
