...
.fixture-card{padding:16px}.fixture-input{width:100%;padding:10px}.fixture-button{width:100%;min-height:52px;padding:10px 14px;border:0;background:#000;color:#fff;font:600 12px/1.35 Arial,sans-serif;letter-spacing:.06em;text-transform:uppercase}.fixture-button[aria-selected=true]{background:#fff;color:#000}
    ...
    for (const viewport of [
      ...
      const report = await page.evaluate(() => {
        ...
        return {
          ...
          activeTabs: document.querySelectorAll('.esencial-workspace-shell__tabs [aria-selected="true"]').length,
          shell: {
