...
<section class="esencial-workspace-shell__section" id="project"><header class="esencial-workspace-shell__section-header"><p class="esencial-workspace-shell__eyebrow">Steg 01</p><div><h2>Projekt</h2><p class="esencial-workspace-shell__section-summary">Välj och redigera ett projekt.</p></div></header><div class="esencial-content-media"><div class="esencial-content-media__picker"><div class="esencial-content-media__actions"><button class="fixture-button">Skapa nytt projekt</button></div><label>Sök projekt<input class="fixture-input" value="Ett långt projektnamn som måste radbrytas lugnt" readonly></label><div class="esencial-content-media__project-list"><button class="esencial-content-media__project-option"><span class="esencial-content-media__project-thumb">Bild</span><span class="esencial-content-media__project-option-copy"><strong>Projekt med lång titel</strong><span>SV · Kladd</span></span></button><button class="esencial-content-media__project-option"><span class="esencial-content-media__project-thumb">Bild</span><span class="esencial-content-media__project-option-copy"><strong>English project</strong><span>EN · Kladd</span></span></button></div></div><div class="esencial-content-media__form-grid"><fieldset class="esencial-content-media__fieldset"><legend>Text</legend><label>Projektnamn<input class="fixture-input" value="Exempel" readonly></label></fieldset><fieldset class="esencial-content-media__fieldset"><legend>Kortbilder</legend><div class="esencial-content-media__media-grid"><div class="esencial-content-media__preview-missing">Kortbild 1</div><div class="esencial-content-media__preview-missing">Kortbild 2</div></div></fieldset></div></div></section>
<section class="esencial-workspace-shell__section" id="filters"><header class="esencial-workspace-shell__section-header"><p class="esencial-workspace-shell__eyebrow">Steg 02</p><div><h2>Filter och ordning</h2></div></header><div class="esencial-projects-feature"><fieldset class="esencial-projects-feature__fieldset"><legend>Nytt filter</legend><label class="esencial-projects-feature__check-row"><input type="checkbox"> Projekt med lång titel</label><button class="fixture-button">Spara filter</button></fieldset><ol class="esencial-projects-feature__order-list"><li class="esencial-projects-feature__order-row"><span>1. Projekt med lång titel</span><button class="fixture-button">Flytta ned</button></li></ol></div></section>
